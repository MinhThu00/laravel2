            ...
            <div class="row">
                <nav id="navbar-primary" class="navbar-primary text-center" aria-label="Navbar Primary"
                    ...
                    <ul id="menu-navbar-primary" class="nav yamm">
                        ...
                        <li class="menu-item animate-dropdown">
                            <a title="PHONES &amp; TABLETS" href="{{ route('contact.index') }}">Liên hệ</a>
                        </li>
                        <li class="menu-item animate-dropdown">
                            <a title="GAMES &amp; CONSOLES" href="{{ route('about.index') }}">Giới thiệu</a>
                        </li>
                        <li class="menu-item animate-dropdown">
                            <a title="ACCESORIES" href="{{ route('terms.index') }}">Chính sách bảo mật &#038; Điều
                                khoản</a>
                        </li>
                        {{-- <li class="menu-item animate-dropdown">
